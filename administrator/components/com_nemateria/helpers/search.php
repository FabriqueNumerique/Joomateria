...
/**
 * L21oaiModelImport : Helper contenant des fonctions importé du helper search de Joomla
 *
 * @package		com_l21oai
 * @subpackage          BackOffice
 * 
 */
class SearchOaiHelper
{
	...
	function logSearch( $search_term )
	{
		...
		$params = &JComponentHelper::getParams( 'com_oai_search' );
