...
<form action="<?php echo JRoute::_('index.php?option=com_nemateria&layout=edit&id_collection='.(int) $this->item->id_collection); ?>" method="post" name="adminForm" id="entry-form" class="form-validate">
