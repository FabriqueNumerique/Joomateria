...
class NemateriaModelNotice  extends JModelItem {

	
	
	protected $context = 'com_exlineo.notice';
	/**
	...
	public function populateState()
	{
		...
		$this->setState('notice.id_notice', $id);
	...
	protected function getStoreId($id = '')
	{
		...
		$id	.= ':'.$this->getState('notice.id_notice');
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Notice', 'Table');
