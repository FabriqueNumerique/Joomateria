...
<h2><?php echo $this->params->get('page_title');  ?></h2></div>
...
<div id="recherche">
	...
	<?php foreach ($this->items as $i => $item) : 
		...
		$link = JRoute::_('index.php?option=com_nemateria&view=notice_texte&id='. $item->slug);
    ...
    <div class="vignette">
            ...
            -->
            <div class="image"><a href="<?php echo $link ?>"><img src="<?php echo JURI::root(); ?>images/collections/collection_mary_hella_200.jpg" alt="" width="200" height="200" class="image"></a></div>
            <!--
            <div class="infos">
              <h3><?php  // echo $item->title.' ('.$item->id_notice.')'; ?></h3>
