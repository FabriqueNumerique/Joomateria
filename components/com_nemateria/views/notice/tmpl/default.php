...
//                echo '<tr>';
//                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_DATEENREGISTREMENT') . '</span>';
...
//            echo '<tr>';
//            echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_FORMAT') . ' : </strong><br />';
...
//            echo '<tr>';
//            echo '<td><span class="notice_title">'  . JText::_('COM_NEMATERIA_RELATION') . ' : </strong></td>';
...
//            echo '<tr>';
//            echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_MAJ') . '</span>';
...
//            echo '<tr>';
//            echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_DATEDEPOT') . '</span>';
...
//                echo '<tr>';
//                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_SNOT_TITRECONV') . '</span>';
...
//            echo '<tr>';
//            echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_SOURCE') . '</span>';
...
//                echo '<tr>';
//                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_ETABLISSEMENT') . '</span>';
...
//                echo '<tr>';
//                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_EDITION') . '</span>';
...
//                echo '<tr>';
//                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_PRESENTATION') . '</span>';
...
//                echo '<tr>';
//                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_INDIDEWEY') . '</span>';
...
//                echo '<tr>';
//                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_SOURCE_PUBLISHER') . '</span>';
...
//                echo '<tr>';
//                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_NUMNOTICE') . '</span>';
...
//                echo '<tr>';
//                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_IMPRESSION') . '</span>';
...
//                echo '<tr>';
//                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_LIENPAGESITE') . '</span>';
...
//                echo '<tr>';
//                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_RIGHTS') . '</span>';
...
//            if (isset($row->medium)) {
//                echo '<tr>';
//                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_TYPOLOGIE_OBJET') . '</span>';
...
//        if (isset($row->issued)) {
//            echo '<tr>';
//            echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_LOCINSEE') . '</span>';
...
//            echo '<tr>';
//            echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_METIER') . '</span>';
...
//            echo '<tr>';
//            echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_REPRODUCTION') . '</span>';
...
//            echo '<tr>';
//            echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_NOTE') . '</span>';
...
//            echo '<tr>';
//            echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_RUBRICLASSEMENT') . '</span>';
...
<div id="notice2" style="color:#000;">
	    ...
	    echo '<div class="module-title-surround">';
	    	echo '<div class="module-title">';
	            ...
	            if ($this->params->get('Facebook') == '0') {
	               ...
	               /*echo '<p id="reseauxFb" class="fb-like">
	                    <iframe src="http://www.facebook.com/plugins/like.php?href='.JURI::current().'&amp;layout=button_count&amp;show_faces=false&amp;width=450&amp;action=like&amp;colorscheme=light" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:25px">
	                    </iframe></p>';*/
	            }
	...
	/*         * ********MINIATURE************* */
                //$miniature = "images/nemateria/images/".$row->relation;
                //$image = "images/nemateria/images/".$row->relation;
        ...
        if(isset($row->isVersionOf) || isset($row->isRequiredBy) || isset($row->isReplacedBy) || isset($row->isFormatOf)){
            ...
            if (isset($row->isVersionOf)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_SNOTTITLE') . '</span>';
                if(!isset($row->isReplacedBy)){
            ...
            if (isset($row->isRequiredBy)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_SNOTCREATOR') . '</span>';
            ...
            if (isset($row->isFormatOf)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_SNOT_DISTRIBMUS') . '</span>';
        ...
        echo '<table class="notice2 tab2">';
            ...
            if ($row->type && $this->params->get('type') == '0') {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_TYPE') . '</span>';
            ...
            if ($row->subject && $this->params->get('sujets') == '0') {
                echo '<tr>';
                echo'<td><span class="notice_title">' . JText::_('COM_NEMATERIA_SUBJECT') . '</span>';
            ...
            if (isset($row->educationLevel)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_THEME') . '</span>';
            ...
            if (isset($row->temporal)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_PERIODE') . '</span>';
            ...
            if (isset($row->replaces)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_GENRE') . '</span>';
            ...
            if ($row->language && $this->params->get('langage') == '0') {
                echo '<tr>';
                echo '<td><span class="notice_title">'  . JText::_('COM_NEMATERIA_LANGAGE') . '</span>';
            ...
            if (isset($row->requires)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_TYPOLOGIE') . '</span>';
        ...
        /************* TABLE 1 *******************/
            ...
            if(isset($row->isVersionOf) || isset($row->isRequiredBy) || isset($row->isReplacedBy) || isset($row->isFormatOf)){
            echo '<tr><td><p><b>'.JText::_('COM_NEMATERIA_SNOT_IN').'</b></p></tr></td>';
        }
            /*         * ********title = TITRE************* */
            if ($row->title && $this->params->get('titre') == '0') {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_TITLE') . '</span>';
                $title = str_ireplace("\r", "", $row->title);
            ...
            if ($row->creator && $this->params->get('createur') == '0') {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_CREATOR') . '</span>';
            ...
            if (isset($row->alternative)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_AUTRECREATEUR') . '</span>';
            ...
            if ($row->contributor && $this->params->get('contributeur') == '0') {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_CONTRIBUTOR') . '</span>';
            ...
            if (isset($row->rightsHolder)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_INTERPRETE') . '</span>';
            ...
            if (isset($row->hasPart)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_PARTICIPANT') . '</span>';
            ...
            if (isset($row->mediator)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_PRODUCTEUR') . '</span>';
            ...
            /*if ($row->description && $this->params->get('description') == '0') {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_DESCRIPTION') . '</span>';
...
/*********************************TABLE 3***********************************************************/
        ...
        echo '<table class="notice2 tab3">';
            ...
            if (isset($row->license)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_EDITEURPUBLI') . '</span>';
            ...
            if ($row->date && $this->params->get('date') == '0') {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_DATEPUBLI') . '</span>';
            ...
            if ($row->coverage && $this->params->get('spatial') == '0') {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_COVERAGE') . '</span>';
            ...
            if (isset($row->extent)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_COLLECTION') . '</span>';
        ...
        if (isset($row->valid)) {
            echo '<tr>';
            echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_LIEN_COLLECTION') . '</span>';
  ...
  //***************************TABLE 4 ****************************************************/   
         echo '<table class="notice2 tab4" >';
            ...
            if (isset($row->created)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_DISTRIBMUSICALE') . '</span>';
            ...
            if (isset($row->accrualPolicy)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_DESCRIPTMUSICALE') . '</span>';
            ...
            if (isset($row->instructionalMethod)) {
                echo '<tr>';
                echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_DESCRIPTMATERIELLE') . '</span>';
        ...
        if (isset($row->conformsTo)) {
            echo '<tr>';
            echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_IDENTIF_COMMERCE') . '</span>';
        ...
        if (isset($row->spatial)) {
            echo '<tr>';
            echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_DISTRIBUTEUR') . '</span>';
        ...
        if ($row->identifier && $this->params->get('identifieur') == '0') {
            echo '<div id="mev">';
            echo '<div class="link">';
            //echo JText::_('COM_NEMATERIA_IDENTIFIEUR');
            ...
            for ($j = 0; $j < sizeof($iden); $j++) {
                ...
                if (substr($chaine, 0, 7) == "http://") {
                    ...
                    if (substr($chaine, $start, $end) == "pdf") {
                        ...
                        echo '<span class="record">' . ("<a  href=\"" . $chaine . "\" target=_blank>  ".JText::_('COM_NEMATERIA_ORIGINAL_LINK')."  </a>") . '</span>';
                    }
                } else {
            ...
            if (isset($row->isReferencedBy)) {
                ...
                //echo '<td><span class="notice_title">' . JText::_('COM_NEMATERIA_IDENTIF_RELATION') . '</span>';
                echo '<a href="'.$row->isReferencedBy.'" target="_blank">' . JText::_('COM_NEMATERIA_ORIGINAL_DOC') . '</a>';
                echo '</div>';
            }   
            echo '</div>';
        }
...
<p class="readon" style="width:100%; display:block;">
    ...
    <a class="button button_noshadow" style="float:right;" href="/index.php/ressources-numeriques/catalogue"><?php echo JText::_('COM_NEMATERIA_NEW_SEARCH') ?></a>
</p>