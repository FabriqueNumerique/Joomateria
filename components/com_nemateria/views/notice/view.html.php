...
//                $a->stylesheet($fichier, $chemin);//chargement de la feuille de style du composant
                ...
                if(isset($this->mp3)){
                    if(JFile::getExt($this->mp3) == 'flv'){
                        JHTML::script('initflv.js', 'components/com_exlineo/js/jplayer/');
                        JHTML::stylesheet('jplayer.blue.monday.css', 'components/com_exlineo/js/jplayer/skin/blue.monday/');
                        JHTML::script('jquery.jplayer.min.js', 'components/com_exlineo/js/jplayer/');
                    }
                    if(JFile::getExt($this->mp3) == 'mp3'){
                        JHTML::stylesheet('circle.player.css', 'components/com_exlineo/js/jplayer/skin/circle.skin/');
                        JHTML::script('jquery.jplayer.min.js', 'components/com_exlineo/js/jplayer/');
                        JHTML::script('jquery.transform2d.js', 'components/com_exlineo/js/jplayer/circle/');
                        JHTML::script('jquery.grab.js', 'components/com_exlineo/js/jplayer/circle/');
                        JHTML::script('mod.csstransforms.min.js', 'components/com_exlineo/js/jplayer/circle/');
                        JHTML::script('circle.player.js', 'components/com_exlineo/js/jplayer/circle/');
                        JHTML::script('init_circ.js', 'components/com_exlineo/js/jplayer/');
                     }
